...
class AcademicScheduleController extends Controller
{
    ...
    {
        $academics = AcademicSchedule::all();

        return AcademicScheduleResource::collection($academics);
    }
    ...
    {
        $academic = AcademicSchedule::find($id);

        return new AcademicScheduleResource($academic);
    }
